...
2. Now, repeat these calculations for when number of flips is 5000 and then 10,000. What happens when you increase the number of flips? To what precision do they resemble the theoretical values (i.e. what decimal do they start to differ)?

3. Use what you just learned to describe the role that the law of large numbers plays in simulation.

### Comparing Multiple Runs
4. Set the number of runs back to 1000. Now, start increasing the number of runs to 3, 5, and 10 runs. Report the mean, variance, and range for the final point at each run.

5. What happens to these measured quantities as you increase the number of runs?

6. Use what you just learned to describe the role that the law of averages plays in simulation.
